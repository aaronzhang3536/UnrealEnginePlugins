...
void FErdanFilePathStructCustomization::CustomizeChildren( TSharedRef<IPropertyHandle> StructPropertyHandle, class IDetailChildrenBuilder& StructBuilder, IPropertyTypeCustomizationUtils& StructCustomizationUtils )
{
	/* do nothing */
}


void FErdanFilePathStructCustomization::CustomizeHeader( TSharedRef<IPropertyHandle> StructPropertyHandle, class FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& StructCustomizationUtils )
{
	...
	HeaderRow
		...
		[
			SNew(SFilePathPicker)
				...
				.FilePath(this, &FErdanFilePathStructCustomization::HandleFilePathPickerFilePath)
				.FileTypeFilter(FileTypeFilter)
				.OnPathPicked(this, &FErdanFilePathStructCustomization::HandleFilePathPickerPathPicked)
		];
}


/* FErdanFilePathStructCustomization callbacks
 *****************************************************************************/

FString FErdanFilePathStructCustomization::HandleFilePathPickerFilePath( ) const
{
	FString FilePath;
...
void FErdanFilePathStructCustomization::HandleFilePathPickerPathPicked( const FString& PickedPath )
{
