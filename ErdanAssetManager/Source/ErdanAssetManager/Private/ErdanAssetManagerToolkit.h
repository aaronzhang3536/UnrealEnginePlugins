...
//
//class FErdanAssetManagerToolkit : public FAssetEditorToolkit
//{
//public:
//
//	FErdanAssetManagerToolkit();
//
...
//public:
//
//	static TSharedRef<FErdanAssetManagerToolkit> CreateEditor( const EToolkitMode::Type Mode, const TSharedPtr< IToolkitHost >& InitToolkitHost, UObject* ObjectToEdit );
//
//	static TSharedRef<FErdanAssetManagerToolkit> CreateEditor( const EToolkitMode::Type Mode, const TSharedPtr< IToolkitHost >& InitToolkitHost, const TArray<UObject*>& ObjectsToEdit );
//
//
//protected:
//
...
//
//private:
//	static TSharedPtr<FErdanAssetManagerToolkit> FindExistingEditor( UObject* Object );
//
